...
export default function GalleryScroll({
	...
	return (
		<div
			...
			className="w-full bg-white lg:flex hidden justify-center"
		>
			<div
				ref={containerRef}
			...
			<div className={cn("fixed z-30 lg:flex hidden flex-col items-end transition-all duration-300 ease-in-out bottom-8 right-8 p-2")} style={style}>
